    ...
    return (
        <div className="fourthContainer">
            <div className="matthewText">
                <img src='https://firebasestorage.googleapis.com/v0/b/fincorp-ac859.appspot.com/o/fourthSection%2Fquote.png?alt=media&token=25358e0d-3086-445b-a905-7658a4835010' alt='' />
